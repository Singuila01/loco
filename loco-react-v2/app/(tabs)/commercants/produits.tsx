    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                <View>
                    <Link href="/commercants/ajoutproduit" style={styles.buttonadd}>Ajouter un produit</Link>
                </View>
...
const styles = StyleSheet.create({
    container: { 
        flex: 1, flexDirection: 'column', backgroundColor: "#f7f7f7", padding: 16, marginBottom: 90,
    },
    content: {
        marginBottom: 80,
    },
